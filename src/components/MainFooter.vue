    ...
    <footer class="container-fluid">
        <div class="container footer">
            <div class="d-flex flex-row flex-wrap align-items-center">
                <div>
                    <div class="d-flex flex-row flex-wrap align-items-center">
                        <img class="footer__logo" src="@/assets/img/sajadidev-logo-primary.svg" alt="SajadiDev Logo" width="36">
                        <p class="footer__title">SajadiDev</p>
                        <p class="footer__notice">کپی رایت © 2025 - کلیه حقوق محفوظ است</p>
                    </div>
                    <div class="footer__links">
                        <div class="d-flex flex-row flex-wrap">
                            <a class="footer__link" href="https://github.com/asajadi84" target="_blank">
                            ...
                            <a class="footer__link" href="https://instagram.com/sajadidev" target="_blank">
                            ...
                            <a class="footer__link" href="https://www.linkedin.com/in/asajadi84" target="_blank">
                            ...
                            <a class="footer__link" href="https://stackoverflow.com/users/6306928/asajadi84" target="_blank">
                            ...
                            <a class="footer__link" href="mailto:alisajadi.sajadi88@gmail.com" target="_blank">
                            ...
                            <a class="footer__link" href="https://wa.me/+989138799532" target="_blank">
                ...
                <div class="ms-auto">
                    <div class="d-flex flex-row flex-wrap footer__certificates">
                        <!-- <script src="https://www.zarinpal.com/webservice/TrustCode" type="text/javascript"></script> -->
                        <img referrerpolicy='origin' id = 'rgvjwlaorgvjsizpjxlzsizp' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=343919&p=xlaoaodsxlaopfvlrfthpfvl", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=343919&p=qftishwlqftibsiynbpdbsiy' />
                        <a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=327079&amp;Code=g36hnqhAKWIIuEoGEdZw"><img referrerpolicy="origin" src="https://Trustseal.eNamad.ir/logo.aspx?id=327079&amp;Code=g36hnqhAKWIIuEoGEdZw" alt="" style="cursor:pointer" id="g36hnqhAKWIIuEoGEdZw"></a>
                    </div>
                </div>
            </div>
        </div>
